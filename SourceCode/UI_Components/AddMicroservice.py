...
class Ui_AddMicroservice(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(9, 9, 380, 220))
        ...
        self.label_replicationIndex = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setBold(True)
        self.label_replicationIndex.setFont(font)
        self.label_replicationIndex.setObjectName("label_replicationIndex")
        self.verticalLayout.addWidget(self.label_replicationIndex)
        self.plainTextEdit_replicationIndex = QtWidgets.QPlainTextEdit(parent=self.verticalLayoutWidget)
        self.plainTextEdit_replicationIndex.setObjectName("plainTextEdit_replicationIndex")
        self.verticalLayout.addWidget(self.plainTextEdit_replicationIndex)        
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=Form)
        self.buttonBox.setGeometry(QtCore.QRect(220, 250, 166, 25))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_replicationIndex.setText(_translate("Form", "Specify the Replication Index"))
